...
define('IMG_USER_PATH','assets/themes/__twoeyes/images/');
...
function ethosLA_enqueue_scripts() {
	...
	wp_enqueue_script('_twoeyes-ui', 'https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js',array(),null,true);
